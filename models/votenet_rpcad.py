...
class RPCADNet(nn.Module):
    def __init__(self, num_class, num_heading_bin, device,
        ...
        self.pnet = ProposalModule(num_class, num_heading_bin, num_proposal, sampling, device=device)

    def forward(self, inputs, pred_cad=False):
        ...
        end_points = self.pnet(xyz, features, point_cloud, end_points, pred_cad)
